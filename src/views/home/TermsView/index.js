...
import { Box, Container, makeStyles, List, ListItem, Typography } from '@material-ui/core'
      ...
      <Page className={classes.root} title='CodeClubs.org - Albuquerque NM USA'>
        ...
        <Container maxWidth={false}>
          <Box mt={3}>
            ...
            <Typography variant='p'>For the purposes of this Privacy Policy:</Typography>
            <List>
              <ListItem>
                <Typography variant='p'>
              ...
              <ListItem>
                <Typography variant='p'>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Tech Workforce NM
                  dba CodeClubs.org, PO Box 21098, Albuquerque, NM 87154.
                </Typography>
              </ListItem>
              <ListItem>
                <Typography variant='p'>
              ...
              <ListItem>
                <Typography variant='p'>
                  <strong>Country</strong> refers to: New Mexico, United States
                </Typography>
              </ListItem>
              <ListItem>
                <Typography variant='p'>
              ...
              <ListItem>
                <Typography variant='p'>
                  <strong>Website</strong> refers to CodeClubs.org, accessible
                  from{' '}
                  <a
                    href='codeclub.org'
            ...
            <Typography variant='h1'>Collecting and Using Your Personal Data</Typography>
            <Typography variant='h2'>Types of Data Collected</Typography>
            <h3>Personal Data</h3>
            <Typography variant='p'>
            ...
            <List>
              ...
              <ListItem>
                <Typography variant='p'>Address, State, Province, ZIP/Postal code, City</Typography>
              </ListItem>
              <ListItem>
            ...
            <h3>Usage Data</h3>
            <Typography variant='p'>Usage Data is collected automatically when using the Service.</Typography>
            <Typography variant='p'>
            ...
            <List>
              ...
              <ListItem>
                ...
                <Typography variant='p'>Type: Persistent Cookies</Typography>
                <Typography variant='p'>Administered by: Us</Typography>
                <Typography variant='p'>
            ...
            <Typography variant='h2'>Use of Your Personal Data</Typography>
            <Typography variant='p'>The Company may use Personal Data for the following purposes:</Typography>
            <List>
              <ListItem>
                <Typography variant='p'>
            ...
            <Typography variant='h2'>Retention of Your Personal Data</Typography>
            <Typography variant='p'>
            ...
            <Typography variant='h2'>Transfer of Your Personal Data</Typography>
            <Typography variant='p'>
            ...
            <Typography variant='h2'>Disclosure of Your Personal Data</Typography>
            ...
            <Typography variant='h2'>Security of Your Personal Data</Typography>
            <Typography variant='p'>
            ...
            <Typography variant='h1'>Children's Privacy</Typography>
            <Typography variant='p'>
            ...
            <List>
              <ListItem>
                <Typography variant='p'>By email: pperez@codeclubs.org</Typography>
              </ListItem>
              <ListItem>
